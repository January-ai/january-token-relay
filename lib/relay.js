  ...
  return async function handler(req, res) {
    ...
    if (origin && allowedOrigins.has(origin)) {
      ...
      res.setHeader(
        ...
        'Authorization, Content-Type, January-End-User-ID',
      )
    }
    ...
    if (req.method === 'GET') {
      ...
      return res.status(200).json({
        ...
        usage: relayTokenRequired
          ? "POST here with headers 'Authorization: Bearer <your RELAY_TOKEN>' and 'January-End-User-ID: <your id for the user>'."
          : "POST here with header 'January-End-User-ID: <your id for the user>'.",
